...
<div class="responsive">
  ...
  <div class="responsive" >
   <div class="row no-gutters" >
    <div class="bomma" style="margin-left:25px;">
  ...
  <div id="caption"></div>
	...
	?>
		 ...
		 <a href="apply.php?id=<?php echo $row['id_user']; ?>" style="float:right;margin-right:75px;" class="btn btn-primary btn-lg margin-top-20">Add to Contacts</a>
		<?php
	} else {	
?>
<a href="remove.php?id=<?php echo $row['id_user']; ?>" style="float:right;margin-right:75px;" class="btn btn-danger btn-lg margin-top-20">Remove Contacts</a>
...
if(isset($_SESSION['removed'])) {
  ?>
  <div>
    <p class="text-center">Contact Sucessfully Removed</p>
  </div>
<?php
